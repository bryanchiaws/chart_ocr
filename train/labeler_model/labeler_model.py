...
feature_extractor = None #ViTFeatureExtractor.from_pretrained(model_name_or_path, device = device)
...
if __name__ == '__main__':
    # usage: python train/labeler_model/labeler_model.py output/labels data/statista_sample_cat output/chart_preds
    ...
    prep = Preprocess_Data(args.features_folder, args.labels_folder)
